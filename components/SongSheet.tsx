...
type Props = {
  ...
  activePerformanceSectionIndex?: number | null;
  activePerformanceSectionLabel?: string | null;
  performanceSectionRefs: React.MutableRefObject<
...
export default function SongSheet({
  ...
  activePerformanceSectionIndex = null,
  ...
  const normaliseSectionLabel = (value: string) => {
    return value
      .trim()
      .toLowerCase()
      .replace(/\s+/g, " ")
  ...
  return (
    ...
    >
      {performanceSections.map((section, sectionIndex) => {
        const activeLabel = activePerformanceSectionLabel
          ? normaliseSectionLabel(activePerformanceSectionLabel)
          : "";

        const sectionLabel = normaliseSectionLabel(section.label);
